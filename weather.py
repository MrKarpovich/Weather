...
DANGER_3 = "🟧 🟧 ВНИМАНИЕ!!! 🟧 🟧 \n\n     " \
           ...
           "\n Возможны травмы от падающих деревьев, повреждения зданий, автомобилей и другой собственности, " \
           "возникнут перебои в подаче электроэнергии и сбои в транспортном движении.\n\n ЧТО ДЕЛАТЬ?! " \
           "СОВЕТЫ ПО БЕЗОПАСНОСТИ!\n\n НЕМЕДЛЕННО!! Держаться подальше ОТ деревьев, рекламных щитов и " \
           "любых других объектов, которые могут снести ветром.\n " \
...
DANGER_4 = "🟥🟥🟥🟥🟥🟥🟥🟥 \n\n⚠️⚠️⚠️ **ТРЕВОГА!!! ВНИМАНИЕ!!!** ⚠️⚠️⚠️" \
           "\n🟥 СРОЧНО ОБРАТИТЕСЬ В СЛУЖБУ СПАСЕНИЯ ДЛЯ ЭВАКУАЦИИ! 🟥" \
           "\n\n**Экстремальная погода!! Немедленно найдите укрытие! Торнадо может нанести серьёзный ущерб здоровью " \
           "и привести к значительным экономическим потерям!\n\nНЕМЕДЛЕННО предпринять меры:\nНайдите укрытие вдали " \
           "от деревьев, рекламных щитов и любых других объектов, которые могут быть унесены ветром.\nЗакройте окна " \
